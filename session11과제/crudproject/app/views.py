...
def mypage(request):
    ...
    like_posts = Like.objects.all()
    wish_posts = Wish.objects.all()
    return render(request, 'mypage.html', {'posts': posts, 'comment': comment, 'like_posts': like_posts, 'wish_posts': wish_posts})
